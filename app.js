...
const div = document.querySelector('#cardproduct')
...
for(let i = 0 ; i < products.length ; i++){
    ...
    div.innerHTML += `<div id = "bg-pruple" class="card  text-danger-emphasis" style="width: 18rem;">
    <div class="card-body">
     ...
     <buttuon type = "button" class = "btn btn-danger text-white" onclick = "getUser()">Add a Card</button>
    </div>
  </div>` 
...
//         console.log(products[j].indexOf)
//     }
